...
function ReturnGiftBags() {
    return (
        <>
            <div className='RcutBack'>
                <h2>D Cut Non Woven Bag</h2>
            </div>
            <div className='Rcutfirstpart'>
            ...
            <div className='Rcutsecoundpart'>
                <h4>Non Woven Bags Manufacturer in India</h4>
                <img src={RcutN} alt='RcutN' className='RcutN' />
            ...
            <div className='Rcutthirdpart'>
                ...
                <h5>Types Of Non Woven Carry Bags</h5>
            ...
            <div className='Rcutfourthpart'>
                <h4>Uses Of Non Woven Carry Bags</h4>
            ...
            <div className='Rcutfivthpart'>
                <h4>Benefits Of Non Woven Carry Bags</h4>
