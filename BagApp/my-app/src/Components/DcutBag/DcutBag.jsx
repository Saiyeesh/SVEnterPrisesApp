...
import dcutimg from "..//../assets/dcutN.jpg";
import dcutN from "..//../assets/dcutN.jpg";

function DcutBag() {
  return (
    <>
      <div className='dcutBack'>
         <h1>D Cut Non Woven Bag</h1>
      </div>
      <div className='dcutfirstpart'>
         <div className='dcutImgBox'>
            <img src={dcutimg} className='dcutImg'/>
         </div>
         <div>
            Table 
         </div>
      </div>
      <div className='dcutsecoundpart'>
          <h2>Non Woven Bags Manufacturer in India</h2>
          <img src={dcutN} alt='dcutN' className='dcutN'/>
