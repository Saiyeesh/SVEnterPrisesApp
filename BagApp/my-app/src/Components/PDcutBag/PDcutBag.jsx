...
import pdcutimg from "..//../assets/dcut.jpg"

function PDcutBag() {
  return (
     <>
       <div className='pdcutBack'>
                <h1>Printed D Cut Non Woven Bag</h1>
             </div>
             <div className='pdcutfirstpart'>
                <div className='pdcutImgBox'>
                   <img src={pdcutimg} className='pdcutImg'/>
                </div>
                <div>
                   Table 
                </div>
             </div>
             <div className='pdcutsecoundpart'>
                 <h2>Non Woven Bags Manufacturer in India</h2>
                 <img src={pdcutimg} alt='pdcutN' className='pdcutN'/>
