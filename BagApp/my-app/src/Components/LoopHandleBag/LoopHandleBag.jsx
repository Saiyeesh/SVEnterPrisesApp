...
function LoopHandleBag() {
  return (
    <>
     <div className='LoopcutBack'>
              <h1>Loop Handle Bag</h1>
           </div>
           <div className='Loopcutfirstpart'>
           ...
           <div className='Loopcutsecoundpart'>
               ...
               <img src={LoopcutN} alt='LoopcutN' className='LoopcutN'/>
           ...
           <div className='Loopcutthirdpart'>
           ...
           <div className='Loopcutfourthpart'>
           ...
           <div className='Loopcutfivthpart'>
