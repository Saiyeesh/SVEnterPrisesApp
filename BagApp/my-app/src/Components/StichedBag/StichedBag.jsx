...
import "./StichedBag.css";
import pLoopcutimg from "..//../assets/stiched.jpg";
import LoopcutN from "..//../assets/stiched.jpg";

function StichedBag() {
    return (
        <>
            <div className='scutBack'>
                <h1>Stiched Non Woven Bag</h1>
            </div>
            <div className='scutfirstpart'>
                <div className='scutImgBox'>
                    <img src={pLoopcutimg} className='scutImg' />
                </div>
                <div>
                    Table
                </div>
            </div>
            <div className='scutsecoundpart'>
                <h2>Non Woven Bags Manufacturer in India</h2>
                <img src={LoopcutN} alt='scutN' className='scutN' />
                <p>At Satnam Overseas, we’re here to make sure you have everything you need to keep your business running smoothly. Our non-woven bags are a great solution for all kinds of businesses, from industrial and manufacturing to retail and wholesale. We’ve been in the industry for over 10 years, so we know exactly what it takes to keep your machines running at peak efficiency.</p>
                <p>We offer a wide range of products: Non-woven bags, D Cut Non-woven bags, W Cut Non-woven bags, U Cut Non-woven bags—all at affordable prices! We can also customize these products for you if you need something special for your business.</p>
                ...
                <p>D cut non-woven bags, in particular, have gained immense popularity in the market as they provide a convenient and reliable option for carrying goods, grocery, and other items.</p>
                <p>D cut non-woven bags are made from spunbonded polypropylene fibers that are bonded together through a process called thermal bonding. This process creates a material that is strong, tear-resistant, and can withstand heavy loads. The bags are called D cut because of the shape of their handles, which are designed to make them easy to carry.</p>
                <p>One of the most significant advantages of using D cut non-woven bags is their environmental friendliness. They are reusable, and unlike plastic bags, they don’t pollute the environment or harm wildlife. D cut non-woven bags can be easily recycled, and their production process consumes less energy and resources compared to traditional plastic bags.</p>
                <p>D cut non-woven bags are also very cost-effective. They are affordable and last longer than traditional plastic bags, making them a more economical option in the long run. They are also easy to customize and can be printed with various designs, logos, and messages. This feature makes them a great option for businesses and organizations looking to promote their brand and message.</p>
            </div>
            <div className='scutthirdpart'>
                <h2>Non Woven Bags</h2>
            ...
            <div className='scutfourthpart'>
                <h2>Uses Of Non Woven Carry Bags</h2>
                <p>These bags are a vastly improved alternative than PE or Polyethylene bags as they are made utilizing polypropylene (PP) which has a very different structure than Polyethylene. As PE has a more steady structure, it is substantially harder to separate. Truth be told, it takes around 300 years for it to get totally bio-degraded. On the contrary, as PP has a less stable chemical structure, it is liable to chain degradation.</p>
                <p>You can buy non-woven bags online on our site and used in grocery store, departmental store, promotional companies, wine bags, cake and coffee bags, food bags to carry large amounts of flour, rice, etc., garment bags, thermal bags, messenger bags, foldable bags, handbags with zippers and drawstring gift bags.</p>
                <p>If you are looking forward to procuring quality non-woven bags – then make sure you’re getting in touch with the reputable non woven bags manufacturer in India. Non-woven carriers are the most environmentally friendly and the most versatile and practical bags in the marketplace today.</p>
            </div>
            <div className='scutfivthpart'>
